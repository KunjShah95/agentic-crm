      ...
      <section className="mx-auto grid max-w-[1280px] gap-10 px-6 py-14 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-16">
        <div className="space-y-6">
          <Card className="overflow-hidden border-border/60">
            {/* Brand panel — office photo with brand scrim for text contrast */}
            <div className="relative h-40 overflow-hidden bg-foreground">
              <Image
                src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjR8fG9mZmljZXxlbnwwfHwwfHx8MA%3D%3D"
                alt="Estate360 team workspace"
                fill
